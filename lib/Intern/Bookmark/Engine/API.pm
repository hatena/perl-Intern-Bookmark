...
sub bookmarks {
    ...
    my $user = $c->user;
    return $c->throw(401 => 'Unauthorized') unless $user;
    ...
    Intern::Bookmark::Service::Bookmark->load_user($c->dbh, $bookmarks);
...
sub bookmark_post {
    ...
    my $url = $c->req->parameters->{url} // $c->throw(400 => 'url required');
    ...
    Intern::Bookmark::Service::Bookmark->load_user($c->dbh, [ $bookmark ]);
